defmodule Tensorflow.CreateSessionRequest do
  ...
  @type t :: %__MODULE__{
          ...
          config: Tensorflow.ConfigProto.t(),
          target: String.t()
        }
...
defmodule Tensorflow.RunStepRequest do
  ...
  @type t :: %__MODULE__{
          ...
          fetch: [String.t()],
          target: [String.t()],
          options: Tensorflow.RunOptions.t(),
...
defmodule Tensorflow.RunStepResponse do
  ...
  @type t :: %__MODULE__{
          ...
          metadata: Tensorflow.RunMetadata.t(),
          status_code: integer,
...
defmodule Tensorflow.PartialRunSetupRequest do
  ...
  defstruct [:session_handle, :feed, :fetch, :target]
...
defmodule Tensorflow.MakeCallableRequest do
  ...
  @type t :: %__MODULE__{
          session_handle: String.t(),
          options: Tensorflow.CallableOptions.t()
        }
  defstruct [:session_handle, :options]
...
defmodule Tensorflow.RunCallableRequest do
  ...
  defstruct [:session_handle, :handle, :feed]
